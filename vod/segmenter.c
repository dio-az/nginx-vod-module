...
segmenter_get_segment_durations_accurate(
	...
	// restore segment boundaries relative to requested clipFrom position
	segment_start = main_track->first_frame_time_offset + main_track->clip_from_frame_offset;
	accum_duration = segment_start;
